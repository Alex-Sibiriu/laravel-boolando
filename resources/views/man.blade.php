                ...
                @if ($product['category'] === 'man')
                    <div class="col mb-3">
                        <div class="card h-100 border-0">
                            ...
                            <div class="card-top">
                                <a href="#">
                                    <img src="{{ Vite::asset('resources/img/') . $product['front_image'] }}"
                                        alt="{{ $product['name'] }}" class="first-img">
                                    <img src="{{ Vite::asset('resources/img/') . $product['back_image'] }}"
                                        alt="{{ $product['name'] }}" class="hover-img">
                                </a>
                                <div class="heart" class="{{ $product['is_in_favorites'] ? 'active' : '' }}">&hearts;</div>
